 ...
 *   - APP_INTERCEPTOR:    LicensePassthroughInterceptor (stamps req.__licenseToken)
 *                          then LoggingInterceptor (writes operation_logs)
 *
...
import { LicensePassthroughInterceptor } from './common/interceptors/license-passthrough.interceptor';
...
@Module({
  ...
  providers: [
    ...
    { provide: APP_INTERCEPTOR, useClass: LicensePassthroughInterceptor },
